...
* **Internationalization** (**i18n**): Configured in [LocaleConfig](https://github.com/Aliuken/JobVacanciesApp_Java17/blob/main/src/main/java/com/aliuken/jobvacanciesapp/config/LocaleConfig.java) (as in <https://www.baeldung.com/spring-boot-internationalization>). Using the interface [Internationalizable](https://github.com/Aliuken/JobVacanciesApp_Java17/blob/main/src/main/java/com/aliuken/jobvacanciesapp/superinterface/Internationalizable.java) (which uses Locale and MessageSource). It is built for:
