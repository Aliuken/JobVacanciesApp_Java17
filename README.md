...
* **Internationalization** (**i18n**): It uses Locale and MessageSource (in the interface [Internationalizable](https://github.com/Aliuken/JobVacanciesApp_Java17/blob/main/src/main/java/com/aliuken/jobvacanciesapp/superinterface/Internationalizable.java)) and is configured in [LocaleConfig](https://github.com/Aliuken/JobVacanciesApp_Java17/blob/main/src/main/java/com/aliuken/jobvacanciesapp/config/LocaleConfig.java) (as in <https://www.baeldung.com/spring-boot-internationalization>). Built for:
