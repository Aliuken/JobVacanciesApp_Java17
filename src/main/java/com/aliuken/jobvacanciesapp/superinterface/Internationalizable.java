...
public interface Internationalizable {
	...
	public default String getMessage(final String languageCode) {
		...
		final String message = StringUtils.getInternationalizedMessage(languageCode, messageName, null);
		return message;
	}

	public default String getMessage(final Language language) {
		final String messageName = getMessageName();
		final String message = StringUtils.getInternationalizedMessage(language, messageName, null);
		return message;
	}

	public default String getMessage(final String languageCode, Object[] messageParameters) {
		final String messageName = getMessageName();
		final String message = StringUtils.getInternationalizedMessage(languageCode, messageName, messageParameters);
		return message;
	}

	public default String getMessage(final Language language, Object[] messageParameters) {
		final String messageName = getMessageName();
		final String message = StringUtils.getInternationalizedMessage(language, messageName, messageParameters);
		return message;
	}
}
