...
public class GenericTableHeaderCellBuilder implements PdfPCellEvent {
	...
	public GenericTableHeaderCellBuilder(final String paragraphText, final boolean isHeaderWithContent, final PdfPCell defaultCell) {
	...
	public final void cellLayout(final PdfPCell cell, final Rectangle position, final PdfContentByte[] canvases) {
		...
		final float y = position.getTop() - HEIGHT - TEXT_PADDING;
