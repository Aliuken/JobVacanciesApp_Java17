...
//	}
	...
	private static final AntPathRequestMatcher[] getStaticResourcesArray() {
		return new AntPathRequestMatcher[]{
			...
			new AntPathRequestMatcher("/fontawesome-free-6.6.0-web/**"),
			...
			new AntPathRequestMatcher("/jquery-ui-1.14.0/**"),
			new AntPathRequestMatcher("/MDB5-STANDARD-UI-KIT-Free-8.0.0/**"),
			new AntPathRequestMatcher("/tinymce-7.3.0/**")
		};
	}
}