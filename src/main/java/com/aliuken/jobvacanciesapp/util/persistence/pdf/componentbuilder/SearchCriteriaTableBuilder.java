...
public class SearchCriteriaTableBuilder implements PdfPTableEvent {
	...
	private static final Font TITLE_FONT = FontFactory.getFont(FontFactory.HELVETICA, BaseFont.CP1252, BaseFont.EMBEDDED, TITLE_FONT_SIZE, Font.UNDEFINED, BaseColor.WHITE);
