...
**JobVacanciesApp_Java17** is an open-source web application made with **OpenJDK 17** and **Spring Boot 3.4** to learn how to make a website to manage job vacancies using state-of-the-art Spring-related technologies.
...
* **Spring Boot 3.4.1**: Starting in the class [MainClass](https://github.com/Aliuken/JobVacanciesApp_Java17/blob/main/src/main/java/com/aliuken/jobvacanciesapp/MainClass.java), which is restartable through the method "MainClass.restartApp(...)". More details in section **[3.4. Spring core technologies](https://github.com/Aliuken/JobVacanciesApp_Java17#34-spring-core-technologies)**.
...
* The following **ad-hoc static files** (located in [src/main/resources/static/jobvacanciesapp-utils](https://github.com/Aliuken/JobVacanciesApp_Java17/tree/main/src/main/resources/static/jobvacanciesapp-utils)):
    ...
    * **page-url-utils.js** [[&#10138;]](https://github.com/Aliuken/JobVacanciesApp_Java17/blob/main/src/main/resources/static/jobvacanciesapp-utils/js/page-url-utils.js): To reload the full page depending on URL parameters extracted from session attributes and model attributes.
    * **page-dom-utils.js** [[&#10138;]](https://github.com/Aliuken/JobVacanciesApp_Java17/blob/main/src/main/resources/static/jobvacanciesapp-utils/js/page-dom-utils.js): To get elements from the current page DOM.

> [!NOTE]
> The decorator [template.html](https://github.com/Aliuken/JobVacanciesApp_Java17/blob/main/src/main/resources/templates/fragments/mandatory/template.html) calls the JS function **getIsPageWithTable()** of [page-dom-utils.js](https://github.com/Aliuken/JobVacanciesApp_Java17/blob/main/src/main/resources/static/jobvacanciesapp-utils/js/page-dom-utils.js) (to check if the current page has a table) and has the following Thymeleaf fragments:
...
> [!NOTE]
> The curriculum/logo files can be compressed into a zip file. A recursive method in [FileType](https://github.com/Aliuken/JobVacanciesApp_Java17/blob/main/src/main/java/com/aliuken/jobvacanciesapp/enumtype/FileType.java) (**getFolderAllowedFilesRecursive**) searches the files with the allowed extensions in the whole list of files inside the folder obtained when the zip file is unzipped (in the method **uploadAndUnzipFile** of [FileUtils](https://github.com/Aliuken/JobVacanciesApp_Java17/blob/main/src/main/java/com/aliuken/jobvacanciesapp/util/persistence/file/FileUtils.java)).