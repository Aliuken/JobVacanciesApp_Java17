...
public class AuthUserQueryReport<T extends AbstractEntity> extends PdfDocument {
	...
	private static final Font URL_TABLE_CELL_FONT = new Font(Font.FontFamily.HELVETICA, 1, Font.NORMAL);
	...
	private PdfPTable createQueryUrlTable() throws DocumentException {
		...
		final String[][] contentArray = new String[][]{{""}};
		final GenericTableBuilder searchUrlTableBuilder = new GenericTableBuilder(columnNames, URL_TABLE_COLUMN_WIDTHS, URL_TABLE_CELL_HORIZONTAL_ALIGNMENT, URL_TABLE_CELL_FONT, contentArray, false, false);
