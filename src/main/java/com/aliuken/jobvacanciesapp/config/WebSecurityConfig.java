...
//	}
	...
	private static final AntPathRequestMatcher[] getStaticResourcesArray() {
		return new AntPathRequestMatcher[]{
			...
			new AntPathRequestMatcher("/bootstrap-5.3.3-dist/**"),
			new AntPathRequestMatcher("/fontawesome-free-6.5.2-web/**"),
			...
			new AntPathRequestMatcher("/jquery-ui-1.13.3/**"),
			new AntPathRequestMatcher("/MDB5-STANDARD-UI-KIT-Free-7.3.0/**"),
			new AntPathRequestMatcher("/tinymce-7.1.1/**")
		};
	}
}